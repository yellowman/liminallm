...
class TestAChatSearchesOnlyWhatItStillHolds:
    ...
    def _search(self, runtime, conversation_id, user_id, query):
        text, _snippets, _chunks, _hints = runtime.workflow._run_file_search(
            query,
            8,
...
class TestAnExtractedTreeIsInvisibleUntilItIsComplete:
    ...
    def test_stale_staging_is_reclaimed_but_a_live_one_is_left(self, tmp_path):
        ...
        _sweep_archive_staging(get_test_store(), tmp_path, max_age_hours=1)
...
class TestAnAutoContextIsNotATransferableCapability:
    ...
    *current* conversation's contexts. The whole per-chat boundary this work
    ...
    def test_another_chat_cannot_name_this_chats_index(self, client):
        ...
        found, _snippets, _chunks, _hints = runtime.workflow._run_file_search(
            "chat a only text",
            8,
