...
class MemoryStore:
    ...
    def update_semantic_cluster(
        ...
        *,
        ...
        if label is not None:
            cluster.label = normalize_optional_text(label)
        if description is not None:
            cluster.description = normalize_optional_text(description)
    ...
    def list_artifacts(
        ...
        *,
        ...
        # Pagination (SPEC default 100, cap 500; allow sentinel row for has_next)
        max_page_size = 500
